...
export function NotificationBell({
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        // right-anchored: the bell sits at the header's right edge, so a
        // left-anchored panel would extend past the viewport on phones.
        <div className="absolute right-0 z-30 mt-2 w-80 max-w-[calc(100vw-2rem)] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">
